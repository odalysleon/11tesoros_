...
<script type="text/javascript">
	var items = {if $cols}{$cols|escape:'htmlall':'UTF-8'}{else}4{/if},
	    itemsDesktop4 = {if $cols}{$cols|escape:'htmlall':'UTF-8'}{else}4{/if},
	    itemsDesktopSmall4 = {if $cols_md}{$cols_md|escape:'htmlall':'UTF-8'}{else}3{/if},
	    itemsTablet4 = {if $cols_sm}{$cols_sm|escape:'htmlall':'UTF-8'}{else}2{/if},
	    itemsMobile4 = {if $cols_xs}{$cols_xs|escape:'htmlall':'UTF-8'}{else}1{/if};
</script>
...
<div class="flex-box top">
	...
	<div class="right-content">
		<div class="flex-box">
			<div class="html-content html-content-fourth">
				{if $banner_html1}
			...
			<div class="img-banner img-banner-fourth">
				{if $banner1}
...
<div class="product-carousel4 item-hover">	
