...
var tab2_items = {if $cols}{$cols|escape:'htmlall':'UTF-8'}{else}4{/if};
	...
	<div class="left-content">
		...
		<div class="banner">
			...
			<div class="banner-content">
				...
				{/if}
				{if $banner_link}
					<a class="button" href="{$banner_link1|escape:'htmlall':'UTF-8'}">{l s='SHOP NOW' d='Modules.JmsPagebuilder'}</a>
				{/if}
			</div>
		</div>
		{/if}
