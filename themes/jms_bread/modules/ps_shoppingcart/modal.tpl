        ...
        <div class="row">
          ...
          <div class="col-md-7">
            <div class="cart-content">
              ...
              <button type="button" class="btn-default btn-secondary btn-effect" data-dismiss="modal">{l s='Continue shopping' d='Shop.Theme.Actions'}</button>
              <a href="{$cart_url}" class="btn btn-effect">{l s='proceed to checkout' d='Shop.Theme.Actions'}</a>
            </div>
          </div>
        </div>
      </div>
