    ...
    <div class="modal-content">
      <div class="modal-body">	
        ...
        <aside id="thumbnails" class="thumbnails js-thumbnails text-xs-center">
			<div class="image-box {if $imagesCount > 5}nomargin{/if}">
				...
				{if $imagesCount > 5}
					<div class="arrows js-modal-arrows">
					  <i class="arrow-up js-modal-arrow-up fa fa-chevron-up"></i>
					  <i class="arrow-down js-modal-arrow-down fa fa-chevron-down"></i>
					</div>
				{/if}
			</div>
        </aside>
