 ...
 *}
<div class="product-miniature js-product-miniature product-box" data-id-product="{$product.id_product}" data-id-product-attribute="{$product.id_product_attribute}" itemscope itemtype="http://schema.org/Product">
	<div class="preview">
    ...
    <div class="product-info">
	    {block name='product_name'}
			<a href="{$product.url}" class="product-name">{$product.name|escape:'html':'UTF-8'}</a>
	    {/block}
	    {if isset($configuration.is_catalog) && !$configuration.is_catalog}
